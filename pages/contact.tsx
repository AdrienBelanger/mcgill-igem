  ...
  return (
    <>
      <div className="bg-black text-white pt-20 pl-20">
        ...
        <form className="w-[80%]  py-16 font-signika" action="https://maker.ifttt.com/trigger/contact/json/with/key/pCur8-zv7nM3JKVeY7viEYwRTNjT39zYxtkw3bs3vfo" method="post">
